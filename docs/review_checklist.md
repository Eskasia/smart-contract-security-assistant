...
| Hackathon submission | `README.md`、`docs/archive/hackathon/003-submission-package-index.md`、`docs/archive/hackathon/007-judge-reproduction-guide.md`、`docs/archive/hackathon/008-issue-remediation-tracker.md`、HackQuest JSON、demo checklist、X post template、live proof blocker fields 與 reproduction steps 完整 |
