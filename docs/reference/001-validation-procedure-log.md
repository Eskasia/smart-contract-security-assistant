...
| Frontend release build | `cd frontend && npm run build` | 2026-05-17：build completed |
| Public benchmark leaderboard | `uv run python eval/run_public_benchmark.py --min-supported-hit-rate 0.95 --min-score-gap 30 --min-recall 0.5 --min-f1 0.5 --leaderboard-output docs/reference/002-public-benchmark-leaderboard.md --leaderboard-date 2026-05-17` | 2026-05-17：`cases=50`, `supported_hit_rate=1.0`, `average_score_gap_safe_minus_vulnerable=45.05`, `precision=0.8621`, `recall=1.0`, `f1=0.9259`, leaderboard generated |
| Diff hygiene | `git diff --check` | 2026-05-17：passed |
| Lint | `uv run ruff check .` | `All checks passed!` |
| Unit + integration tests | `uv run pytest` | 2026-05-17：`102 passed in 17.76s` |
| Frontend tests | `cd frontend && npm run test -- --run` | 2026-05-17：`6 files`, `32 passed` |
| Frontend build | `cd frontend && npm run build` | 2026-05-17：build completed |
| RAG recall eval | `uv run python eval/run_eval.py` | 2026-05-17：`cases=8`, `recall_at_k=1.0` |
| Judge eval | `uv run python eval/run_judge.py` | 2026-05-17：`cases=4`, `local_average_judge_score=5.0`, `external_average_judge_score=5.0` |
...
| Public project build preflight | `uv run python eval/run_public_project_builds.py --preflight-only` | 2026-05-17：`cases=10`, `forge=true`, `npx=true`, `missing_required_tools=[]` |
