...
| guides | 001 | current | 使用說明書 | 說明安裝、分析、trace 查詢、MLX probe、Web UI 與輸出檔案。 | 2026-04-30 | `docs/guides/001-usage-manual.md` |
| review | 001 | current | Review Checklist | 記錄 git baseline、CI、project input、corpus、detector、report 與 judge 審查門檻。 | 2026-04-30 | `docs/review_checklist.md` |
