...
|---|---:|---:|---|
| GitHub stars | 1 | 100 | GitHub repo API snapshot on 2026-07-06: `stargazers_count=1` |
| GitHub forks | 0 | 30 | GitHub repo API snapshot on 2026-07-06: `forks_count=0` |
...
| Monthly downloads | 0 | 1000 | PyPI package `smart-contract-security-assistant` is published at version `0.2.1`, but PyPI JSON does not provide a package-hosted monthly download counter; GitHub `v0.2.1` release asset download total was `0` on 2026-07-06 |
