...
number: "004"
status: draft
services: ["integrations/0g", "README.hackathon.md"]
...
本文件是 HackQuest 「0G Integration Proof」的單一事實來源。完成 live upload/register 後，把相同欄位同步回 `README.hackathon.md`、`docs/hackathon/0g-apac-submission.md` 與 HackQuest 表單。
