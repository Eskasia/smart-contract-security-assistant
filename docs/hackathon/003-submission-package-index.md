...
number: "003"
status: draft
services: ["docs/hackathon", "README.hackathon.md", "integrations/0g"]
...
| README / documentation | Overview, architecture, 0G modules, reproduction steps, reviewer notes | `README.hackathon.md` and `docs/hackathon/007-judge-reproduction-guide.md` | ready except live fields |
...
`docs/hackathon/004-live-0g-proof-record.md` is the source of truth for all 0G proof fields. After it is filled, copy values to README, HackQuest Markdown, HackQuest JSON, and this submission folder in one edit.
